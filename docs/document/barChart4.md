...
```
<script setup>
import demo1e24126d9f1f from '../../document/barChart4/1.基础用法.vue'
import demo8a5b60acad9c from '../../document/barChart4/2.调整宽度与显示行数.vue'
import demo70171395c6aa from '../../document/barChart4/3.设置高亮区域与颜色.vue'
</script>