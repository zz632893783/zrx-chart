...
```
<script setup>
import demo32d11ab74481 from '../../document/barChart/1.基础用法.vue'
import demo8510eeba669b from '../../document/barChart/2.指定区域高亮.vue'
import demoae42ae6d8f00 from '../../document/barChart/3.拖拽区域为滚动条.vue'
</script>