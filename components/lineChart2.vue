...
const props = defineProps({
    ...
    color: {
        type: [Array],
        default: () => ['rgb(243, 220, 60)', 'rgb(102, 255, 255)']
    },
    /**
...
// legend 图标映射
const legendIcon = 'path://M8,16A8,8,0,0,0,24,16L21,16A5,5,0,0,1,11,16M8,16A8,8,0,1,1,24,16L21,16A5,5,0,1,0,11,16M0,15L8,15L8,17L0,17M32,15L24,15L24,17L32,17';
// 渲染函数
const renderChart = () => {
    if (chart) {
        chart.dispose();
    ...
    const option = {
        ...
        series: (() => {
            ...
            const series = props.seriesData.map((seriesItem, seriesIndex) => {
                ...
                //     seriesOption.itemStyle = props.color[seriesIndex % props.color.length];
                //     seriesOption.label = {
                //         show: true,
                    ...
                    color: props.showLineArea ?
                        {
                            ...
                            x: 0, y: 0, x2: 0, y2: 1,
                            colorStops: [
                                { offset: 0, color: `rgba(${ r }, ${ g }, ${ b }, ${ a * 0.25 })` },
